...
def plot_evaluation_results(labels: ndarray, trn_y, prd_trn, tst_y, prd_tst):
    ...
    print((tn_trn + tp_trn) / (tn_trn + tp_trn + fp_trn + fn_trn), (tn_tst + tp_tst) / (tn_tst + tp_tst + fp_tst + fn_tst))
    print(tp_trn / (tp_trn + fn_trn), tp_tst / (tp_tst + fn_tst))
    print(tn_trn / (tn_trn + fp_trn), tn_tst / (tn_tst + fp_tst))
    print(tp_trn / (tp_trn + fp_trn), tp_tst / (tp_tst + fp_tst))
